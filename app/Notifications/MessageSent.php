...
class MessageSent extends Notification
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                    ...
                    ->line('Para leer tu mensjae haz click en el boton.')
                    ->action('Ver mensaje', route('messages.show',$this->message->id))
                    // ->action('Notification Action', url('/'))
                    ->line('Hasta luego...');

        # ENVIAR UN EMAIL PERSONALIZADO
        // return (new MailMessage)->view('emails.message',['message' => $this->message]);
    }
    ...
    /**
     * Notificacion por medio de broadcast
     *
     * @param [type] $notifiable
     * @return void
     */
